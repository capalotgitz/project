...
<div class="topbar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p class="pull-left hidden-xs">Mama Rocks Restraunt</p>
        <p class="pull-right"><i class="fa fa-phone"></i>Order Online +254712356899</p>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="navbar-header">
            ...
            <div id="fixed-collapse-navbar" class="navbar-collapse collapse navbar-right">
              <ul class="nav navbar-nav">
                ...
                <li><a href="logic/register.php">Order Now</a></li>
				...
				<!-- START REVOLUTION SLIDER 5.0.7 fullwidth mode -->
					<div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                        ...
                        <div class="tp-caption fade tp-resizeme"
                          ...
                          data-start="1200"
                           style="z-index: 12;">
                       <a href="logic/register.php" class="btn-common btn-white page-scroll">Order Now</a>
                       </div>
      ...
      <div class="col-md-12">
        <div class="cheffs_wrap_slider">
          <div id="news-slider" class="owl-carousel">
            ...
            <div class="item">
              <div class="news_content">
               <img src="images/food-3.jpg" alt="Docotor">
               <div class="date_comment">
                  <span>22<small>apr</small></span>
                   <a href="#."><i class="icon-comment"></i> 5</a>
               </div>
               <div class="comment_text">
                 <h3><a href="#.">Chilly Chicken</a></h3>
                 <p>Enjoy Delicious Food!</p>
               </div>
              </div>
            </div>
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div id="testinomial-slider" class="owl-carousel text-center">
        <div class="item">
          <img src="images/Juma.jpeg" alt="">
          <h3>Awesome Food. Food from some of the finest restaurants in Nairobi, Kenya!</h3>
          <p>Jacob Juma</p>
        </div>
 
        <div class="item">
          <img src="images/lingard.jpeg" alt="">
          <h3>Good Recipes, Nice staff and customer care. A good service overall</h3>
          <p>Alex Sunford</p>
        </div>
        <div class="item">
          <img src="images/wahu.jpeg" alt="">
          <h3>Awesome Food. Food from some of the finest restaurants in Kenya!</h3>
          <p>Carrie Wahu</p>
        </div>
       </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-6 footer_column">
        ...
        <p>Launched in Westlands, Mama Rocks has grown from a home project to one of the largest food aggregators in the world. We are present in 24 countries and 10000+ cities globally, enabling our vision of better food for more people. We not only connect people to food in every context but work closely with restaurants to enable a sustainable ecosystem.</p>
      </div>
      <div class="col-md-3 col-sm-6 footer_column">
      ...
      <div class="col-md-3 col-sm-6 footer_column">
        ...
        <hr class="half_space">
        <p></p>
        <p class="address"><i class="icon-location"></i>Mama Rocks Restraunt.</p>
        <p class="address"><i class="fa fa-phone"></i>+254712356899</p>
        </div> 
    </div>
    <div class="row">
     <div class="col-md-12">
