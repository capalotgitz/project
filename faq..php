...
<div class="topbar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p class="pull-left hidden-xs">Mama Rocks, the Best in Town</p>
        <p class="pull-right"><i class="fa fa-phone"></i>Order Online +2547123567899</p>
      </div>
    </div>
  </div>
</div>
        ...
        <div class='faq_wrapper'>
          <ul class='items'>
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p class="half_space"> Please call us on +2547123567899 mentioning your Order.</p>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p class="half_space">Orders are delivered directly via our Boda Boda guys and you should check the order via  email and SMS.</p>
                </li>
              </ul>
            </li>
            <li>
